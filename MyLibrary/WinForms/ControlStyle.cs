    ...
    public class ControlStyle
    {
        ...
        public void ApplyStyle(Control control, bool recursive = true)
        {
            ...
            else if (control is MyDataGridView myDataGridView)
            {
                ...
                if (style != null)
                {
                    myDataGridView.AlternatingRowsDefaultCellStyle = style.AlternatingRowsDefaultCellStyle;
                    ...
                    myDataGridView.ColumnHeadersDefaultCellStyle = style.ColumnHeadersDefaultCellStyle;
